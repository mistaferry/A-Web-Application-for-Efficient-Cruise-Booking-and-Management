...
VALUES (1, 4, 6300, '2023-03-03', 4),
       (2, 8, 12000, '2023-04-12', 4),
       (3, 12, 22220, '2023-04-30', 2),
       (5, 8, 11300, '2023-04-23', 2),
       (4, 8, 9000, '2023-04-30', 4),
       (3, 12, 19200, '2023-09-01', 1),
       (1, 12, 31999, '2023-05-31', 4);
...
VALUES (1, 2, '2023-01-12', true),
       (2, 1, '2023-01-12', true),
       (3, 5, '2023-01-03', false),
       (4, 5, '2022-12-10', true),
       (5, 5, '2023-01-11', true),
       (6, 1, '2022-11-01', false),
       (3, 4, '2023-01-23', true),
       (2, 3, '2023-01-04', true),
       (1, 5, '2023-01-19', true),
       (1, 7, '2022-10-29', true),
       (1, 5, '2023-01-25', false),
       (1, 2, '2023-01-05', false),
       (1, 3, '2022-12-30', false),
       (1, 6, '2022-08-05', false);
