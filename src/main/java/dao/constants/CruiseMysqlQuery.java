...
public class CruiseMysqlQuery {
    public static final String ADD_CRUISE = "INSERT INTO cruise (ship_id, duration, start_day, paid, number_of_ports, start_port, end_port) VALUES (?, ?, ?, ?, ?, ?, ?)";

    public static final String GET_BY_ID = "SELECT cruise WHERE id=?";

    public static final String GET_ALL = "SELECT * FROM cruise";
